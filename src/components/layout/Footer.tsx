        ...
        {/* <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            ...
            <ul className="space-y-3">
              <li>
                <Link href="#" className="text-white hover:text-gray-300">
                  {getTextByLanguage(translations.common.features, language)}
                </Link>
              </li>
              <li>
                <Link href="#" className="text-white hover:text-gray-300">
              ...
              <li>
                <Link href="#" className="text-white hover:text-gray-300">
                  {language === 'ko' ? 'AI 기술' : 'AI Technology'}
                </Link>
              </li>
              <li>
                <Link href="#" className="text-white hover:text-gray-300">
              ...
              <li>
                <Link href="#" className="text-white hover:text-gray-300">
                  {getTextByLanguage(translations.common.pricing, language)}
                </Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link href="#" className="text-white hover:text-gray-300">
                  {language === 'ko' ? 'API 참조' : 'API Reference'}
                </Link>
              </li>
              <li>
                <Link href="#" className="text-white hover:text-gray-300">
              ...
              <li>
                <Link href="#" className="text-white hover:text-gray-300">
                  {language === 'ko' ? '사례 연구' : 'Case Studies'}
                </Link>
              </li>
              <li>
                <Link href="#" className="text-white hover:text-gray-300">
                  {language === 'ko' ? '웨비나' : 'Webinars'}
                </Link>
              </li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link href="#" className="text-white hover:text-gray-300">
                  {getTextByLanguage(translations.footer.links.about, language)}
                </Link>
              </li>
              <li>
                <Link href="#" className="text-white hover:text-gray-300">
