          ...
          <div className="bg-gray-50 rounded-lg p-6 mb-8">
            ...
            <div className="space-y-3">
              ...
              <div className="flex justify-between">
                ...
                <span className="font-medium">{searchParams.get('studioName') || '스튜디오'}</span>
              </div>
              <div className="flex justify-between">
                <span className="text-gray-600">참여 멤버 수</span>
                <span className="font-medium">{searchParams.get('memberCount') || '0'}명</span>
              </div>
              <div className="flex justify-between">
